...
describe('RecurringController', () => {
  ...
  beforeAll(() => {
    controller = new RecurringController(testClient);
  });

  it('should Test List all recurring record', async () => {
    const response = await makeApiCall(
      () => controller.listAllRecurringRecord(
        undefined,
        undefined,
        undefined,
        undefined,
    ...
    const expected: ResponseRecurringsCollection = {
      type: Type63Enum.RecurringsCollection,
      list: [
        {
          ...
          nextRunDateMin: '2021-12-01',
          nextRunDateMax: '2021-12-01',
          allTags: [
            {
              locationId: '11e95f8ec39de8fbdb0a4f1a',
              title: 'My terminal',
  ...
  it('should Test Delete recurring record', async () => {
    const recurringId = '11e95f8ec39de8fbdb0a4f1a';

    const response = await makeApiCall(
      () => controller.deleteRecurringRecord(recurringId)
    );
    ...
    const expected: ResponseRecurring = {
      type: Type62Enum.Recurring,
      data: {
        accountVaultId: '11e95f8ec39de8fbdb0a4f1a',
        tokenId: '11e95f8ec39de8fbdb0a4f1a',
        contactId: '11e95f8ec39de8fbdb0a4f1a',
  ...
  it('should Test View single recurring record', async () => {
    const recurringId = '11e95f8ec39de8fbdb0a4f1a';

    const response = await makeApiCall(
      () => controller.viewSingleRecurringRecord(
        recurringId,
        undefined,
        undefined
      )
  ...
  it('should Test Activate recurring payment', async () => {
    const recurringId = '11e95f8ec39de8fbdb0a4f1a';

    const response = await makeApiCall(
      () => controller.activateRecurringPayment(recurringId, undefined)
    );
  ...
  it('should Test Place on hold recurring payment', async () => {
    const recurringId = '11e95f8ec39de8fbdb0a4f1a';

    const response = await makeApiCall(
      () => controller.placeOnHoldRecurringPayment(recurringId, undefined)
    );
