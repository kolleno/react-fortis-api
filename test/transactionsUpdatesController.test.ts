...
describe('TransactionsUpdatesController', () => {
  let controller : TransactionsUpdatesController;

  beforeAll(() => {
    controller = new TransactionsUpdatesController(testClient);
  });

  it('should Test Void', async () => {
    const transactionId = '11e95f8ec39de8fbdb0a4f1a';

    const response = await makeApiCall(
      () => controller.mVoid(transactionId, undefined)
    );
