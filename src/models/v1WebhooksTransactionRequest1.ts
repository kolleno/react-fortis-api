...
export interface V1WebhooksTransactionRequest1 {
...
export const v1WebhooksTransactionRequest1Schema: Schema<V1WebhooksTransactionRequest1> = expandoObject(
  {
    ...
    numberOfAttempts: ['number_of_attempts', optional(nullable(number()))],
