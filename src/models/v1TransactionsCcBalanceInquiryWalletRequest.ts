...
export interface V1TransactionsCcBalanceInquiryWalletRequest {
  /** Additional amounts */
...
export const v1TransactionsCcBalanceInquiryWalletRequestSchema: Schema<V1TransactionsCcBalanceInquiryWalletRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
