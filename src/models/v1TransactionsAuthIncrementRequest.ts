...
export interface V1TransactionsAuthIncrementRequest {
  /** Additional amounts */
...
export const v1TransactionsAuthIncrementRequestSchema: Schema<V1TransactionsAuthIncrementRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
