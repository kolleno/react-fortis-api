...
export interface V1TransactionsCcAuthOnlyWalletRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAuthOnlyWalletRequestSchema: Schema<V1TransactionsCcAuthOnlyWalletRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
