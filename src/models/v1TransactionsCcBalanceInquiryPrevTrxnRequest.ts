...
import { Joi27, joi27Schema } from './joi27';
import { WalletTypeEnum, walletTypeEnumSchema } from './walletTypeEnum';

export interface V1TransactionsCcBalanceInquiryPrevTrxnRequest {
  /** Additional amounts */
  ...
  previousTransactionApiId?: string | null;
  joi?: Joi27;
...
export const v1TransactionsCcBalanceInquiryPrevTrxnRequestSchema: Schema<V1TransactionsCcBalanceInquiryPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
    ...
    previousTransactionId: ['previous_transaction_id', optional(string())],
    previousTransactionApiId: [
      'previous_transaction_api_id',
      optional(nullable(string())),
    ],
    joi: ['_joi', optional(lazy(() => joi27Schema))],
