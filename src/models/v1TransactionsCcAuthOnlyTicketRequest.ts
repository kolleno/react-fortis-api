...
export interface V1TransactionsCcAuthOnlyTicketRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAuthOnlyTicketRequestSchema: Schema<V1TransactionsCcAuthOnlyTicketRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
