...
export interface V1TransactionsCcRefundTerminalRequest {
  /** Additional amounts */
...
export const v1TransactionsCcRefundTerminalRequestSchema: Schema<V1TransactionsCcRefundTerminalRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
