...
export interface V1TransactionsCcSaleTaptopayRequest {
  /** Additional amounts */
...
export const v1TransactionsCcSaleTaptopayRequestSchema: Schema<V1TransactionsCcSaleTaptopayRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
