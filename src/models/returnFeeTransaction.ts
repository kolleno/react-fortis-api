...
export interface ReturnFeeTransaction {
  /** Additional amounts */
...
export const returnFeeTransactionSchema: Schema<ReturnFeeTransaction> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
    ...
    reasonCodeId: [
      'reason_code_id',
      optional(nullable(reasonCodeId1EnumSchema)),
    ],
