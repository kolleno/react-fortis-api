...
export interface V1TransactionsCcRefundWalletRequest {
  /** Additional amounts */
...
export const v1TransactionsCcRefundWalletRequestSchema: Schema<V1TransactionsCcRefundWalletRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
