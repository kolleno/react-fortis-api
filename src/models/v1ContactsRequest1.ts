...
export interface V1ContactsRequest1 {
  /** Location ID */
...
export const v1ContactsRequest1Schema: Schema<V1ContactsRequest1> = expandoObject(
  {
    ...
    headerMessageType: ['header_message_type', optional(nullable(number()))],
    updateIfExists: [
      'update_if_exists',
