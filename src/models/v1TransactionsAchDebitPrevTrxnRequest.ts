...
export interface V1TransactionsAchDebitPrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsAchDebitPrevTrxnRequestSchema: Schema<V1TransactionsAchDebitPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
