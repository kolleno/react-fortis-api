...
export interface V1TransactionsAuthCompleteRequest {
  /** Additional amounts */
...
export const v1TransactionsAuthCompleteRequestSchema: Schema<V1TransactionsAuthCompleteRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
