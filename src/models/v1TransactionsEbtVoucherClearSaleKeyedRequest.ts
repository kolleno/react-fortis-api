...
export interface V1TransactionsEbtVoucherClearSaleKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsEbtVoucherClearSaleKeyedRequestSchema: Schema<V1TransactionsEbtVoucherClearSaleKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
