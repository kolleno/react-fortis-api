...
export interface V1TransactionsAchCreditTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsAchCreditTokenRequestSchema: Schema<V1TransactionsAchCreditTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
