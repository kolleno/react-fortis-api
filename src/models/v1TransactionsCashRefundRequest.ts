...
export interface V1TransactionsCashRefundRequest {
  /** Additional amounts */
...
export const v1TransactionsCashRefundRequestSchema: Schema<V1TransactionsCashRefundRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
