...
export interface V1TransactionsCcAuthOnlyTerminalRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAuthOnlyTerminalRequestSchema: Schema<V1TransactionsCcAuthOnlyTerminalRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
