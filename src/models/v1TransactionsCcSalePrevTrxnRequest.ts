...
export interface V1TransactionsCcSalePrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsCcSalePrevTrxnRequestSchema: Schema<V1TransactionsCcSalePrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
