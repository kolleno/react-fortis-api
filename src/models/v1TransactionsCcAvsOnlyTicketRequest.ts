...
export interface V1TransactionsCcAvsOnlyTicketRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAvsOnlyTicketRequestSchema: Schema<V1TransactionsCcAvsOnlyTicketRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
