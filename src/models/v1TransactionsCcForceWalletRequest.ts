...
export interface V1TransactionsCcForceWalletRequest {
  /** Additional amounts */
...
export const v1TransactionsCcForceWalletRequestSchema: Schema<V1TransactionsCcForceWalletRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
