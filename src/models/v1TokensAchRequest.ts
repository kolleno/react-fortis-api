...
import { Joi18, joi18Schema } from './joi18';

export interface V1TokensAchRequest {
  /**
   * Account holder name
...
export const v1TokensAchRequestSchema: Schema<V1TokensAchRequest> = expandoObject(
  {
    ...
    joi: ['_joi', optional(lazy(() => joi18Schema))],
    accountType: ['account_type', optional(nullable(accountType13EnumSchema))],
    isCompany: ['is_company', optional(boolean())],
