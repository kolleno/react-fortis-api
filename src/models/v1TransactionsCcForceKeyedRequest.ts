...
export interface V1TransactionsCcForceKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsCcForceKeyedRequestSchema: Schema<V1TransactionsCcForceKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
