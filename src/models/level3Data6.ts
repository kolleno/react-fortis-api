...
import { LineItem20, lineItem20Schema } from './lineItem20';
import { TaxExemptEnum, taxExemptEnumSchema } from './taxExemptEnum';

/** Level 3 data object */
export interface Level3Data6 {
  ...
  lineItems: LineItem20[];
  [key: string]: unknown;
}

export const level3Data6Schema: Schema<Level3Data6> = expandoObject({
  ...
  lineItems: ['line_items', array(lazy(() => lineItem20Schema))],
});
