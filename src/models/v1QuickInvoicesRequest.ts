...
import { ItemList4, itemList4Schema } from './itemList4';

export interface V1QuickInvoicesRequest {
  /** Location ID */
...
export const v1QuickInvoicesRequestSchema: Schema<V1QuickInvoicesRequest> = expandoObject(
  {
    ...
    itemList: ['item_list', array(lazy(() => itemList4Schema))],
