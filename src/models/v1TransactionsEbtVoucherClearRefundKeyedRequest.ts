...
export interface V1TransactionsEbtVoucherClearRefundKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsEbtVoucherClearRefundKeyedRequestSchema: Schema<V1TransactionsEbtVoucherClearRefundKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
