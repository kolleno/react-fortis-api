...
import {
  ...
  v1TransactionsCcRefundKeyedRequestAccountNumberSchema,
} from './containers/v1TransactionsCcRefundKeyedRequestAccountNumber';
import {
  V1TransactionsCcRefundKeyedRequestExpDate,
  v1TransactionsCcRefundKeyedRequestExpDateSchema,
} from './containers/v1TransactionsCcRefundKeyedRequestExpDate';
...
export interface V1TransactionsCcRefundKeyedRequest {
  /** Additional amounts */
   ...
   * >String lengths are conditional, CC should be 13-19 and ACH should be 4-19. Required if account_vault_id , track_data, or micr_data is not provided.
   * >
   */
  accountNumber?: V1TransactionsCcRefundKeyedRequestAccountNumber;
  ...
  expDate?: V1TransactionsCcRefundKeyedRequestExpDate;
...
export const v1TransactionsCcRefundKeyedRequestSchema: Schema<V1TransactionsCcRefundKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
    ...
    accountNumber: [
      'account_number',
      optional(v1TransactionsCcRefundKeyedRequestAccountNumberSchema),
    ],
    cvv: ['cvv', optional(nullable(string()))],
    entryModeId: ['entry_mode_id', optional(nullable(entryModeIdEnumSchema))],
    expDate: [
      'exp_date',
      optional(v1TransactionsCcRefundKeyedRequestExpDateSchema),
    ],
    trackData: ['track_data', optional(nullable(string()))],
    pin: ['pin', optional(nullable(string()))],
    ksn: ['ksn', optional(nullable(string()))],
