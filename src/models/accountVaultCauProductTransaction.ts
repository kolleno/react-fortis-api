...
export interface AccountVaultCauProductTransaction {
  /** Location ID */
  id?: string;
  /** Created Time Stamp */
  createdTs?: number;
...
export const accountVaultCauProductTransactionSchema: Schema<AccountVaultCauProductTransaction> = expandoObject(
  {
