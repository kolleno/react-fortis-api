...
import { BrandingDomain, brandingDomainSchema } from './brandingDomain';
import { LocationTypeEnum, locationTypeEnumSchema } from './locationTypeEnum';
import {
  ProductAccountvault,
  productAccountvaultSchema,
} from './productAccountvault';
import { ProductFile, productFileSchema } from './productFile';
import { ProductRecurring, productRecurringSchema } from './productRecurring';
import { ProductToken, productTokenSchema } from './productToken';
import {
  ProductTransaction1,
...
export const data11Schema: Schema<Data11> = expandoObject({
  ...
  brandingDomain: [
    'branding_domain',
    optional(lazy(() => brandingDomainSchema)),
  ],
  productTransactions: [
    'product_transactions',
    optional(array(lazy(() => productTransaction1Schema))),
  ],
  productFile: ['product_file', optional(lazy(() => productFileSchema))],
  productAccountvault: [
    'product_accountvault',
    optional(lazy(() => productAccountvaultSchema)),
  ],
  productToken: ['product_token', optional(lazy(() => productTokenSchema))],
  productRecurring: [
    'product_recurring',
    optional(lazy(() => productRecurringSchema)),
  ],
