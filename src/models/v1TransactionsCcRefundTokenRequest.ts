...
export interface V1TransactionsCcRefundTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsCcRefundTokenRequestSchema: Schema<V1TransactionsCcRefundTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
