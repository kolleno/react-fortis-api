...
export interface V1TransactionsCcAvsOnlyTerminalRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAvsOnlyTerminalRequestSchema: Schema<V1TransactionsCcAvsOnlyTerminalRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
