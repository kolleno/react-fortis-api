...
export interface V1TransactionsCcForceTicketRequest {
  /** Additional amounts */
...
export const v1TransactionsCcForceTicketRequestSchema: Schema<V1TransactionsCcForceTicketRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
