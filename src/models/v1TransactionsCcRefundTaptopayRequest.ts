...
export interface V1TransactionsCcRefundTaptopayRequest {
  /** Additional amounts */
...
export const v1TransactionsCcRefundTaptopayRequestSchema: Schema<V1TransactionsCcRefundTaptopayRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
