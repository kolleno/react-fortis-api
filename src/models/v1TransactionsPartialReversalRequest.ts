...
export interface V1TransactionsPartialReversalRequest {
  /** Additional amounts */
...
export const v1TransactionsPartialReversalRequestSchema: Schema<V1TransactionsPartialReversalRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
