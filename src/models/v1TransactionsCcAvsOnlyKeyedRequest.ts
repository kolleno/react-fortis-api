...
export interface V1TransactionsCcAvsOnlyKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAvsOnlyKeyedRequestSchema: Schema<V1TransactionsCcAvsOnlyKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
