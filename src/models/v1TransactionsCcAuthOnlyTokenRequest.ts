...
export interface V1TransactionsCcAuthOnlyTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAuthOnlyTokenRequestSchema: Schema<V1TransactionsCcAuthOnlyTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
