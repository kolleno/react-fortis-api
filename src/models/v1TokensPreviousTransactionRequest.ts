...
export interface V1TokensPreviousTransactionRequest {
  /**
   * Account holder name
...
export const v1TokensPreviousTransactionRequestSchema: Schema<V1TokensPreviousTransactionRequest> = expandoObject(
  {
    ...
    previousTransactionId: ['previous_transaction_id', string()],
