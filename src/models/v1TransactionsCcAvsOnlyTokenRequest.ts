...
export interface V1TransactionsCcAvsOnlyTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAvsOnlyTokenRequestSchema: Schema<V1TransactionsCcAvsOnlyTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
