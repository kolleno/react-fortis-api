...
import {
  AccountType16Enum,
  accountType16EnumSchema,
} from './accountType16Enum';
...
export interface V1TransactionsAchCreditKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsAchCreditKeyedRequestSchema: Schema<V1TransactionsAchCreditKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
    ...
    accountType: ['account_type', accountType16EnumSchema],
