...
export interface V1TransactionsCcAuthOnlyTaptopayRequest {
  /** Additional amounts */
  ...
  /** Delay Charge */
  delayCharge?: boolean;
  /** Encrypted Cardholder data. Used in Tap to Pay transactions */
  cardDataCryptogram: string;
  /** Plaintext EMV tags. Used in Tap to Pay transactions */
  generalCardData: string;
  /** Identifier of card reader used in Tap to Pay transactions. */
  cardReaderId: string;
  [key: string]: unknown;
}

export const v1TransactionsCcAuthOnlyTaptopayRequestSchema: Schema<V1TransactionsCcAuthOnlyTaptopayRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
    ...
    cardDataCryptogram: ['card_data_cryptogram', string()],
    generalCardData: ['general_card_data', string()],
    cardReaderId: ['card_reader_id', string()],
  }
);
