...
export interface V1TransactionsCcForceTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsCcForceTokenRequestSchema: Schema<V1TransactionsCcForceTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
