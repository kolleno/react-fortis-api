...
export interface V1TransactionsCcAvsOnlyPrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAvsOnlyPrevTrxnRequestSchema: Schema<V1TransactionsCcAvsOnlyPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
