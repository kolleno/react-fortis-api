...
export interface V1TransactionsCcAuthOnlyKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAuthOnlyKeyedRequestSchema: Schema<V1TransactionsCcAuthOnlyKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
