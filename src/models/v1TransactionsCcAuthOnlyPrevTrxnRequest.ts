...
export interface V1TransactionsCcAuthOnlyPrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsCcAuthOnlyPrevTrxnRequestSchema: Schema<V1TransactionsCcAuthOnlyPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
