...
import { Recurring, recurringSchema } from './recurring';
...
export const list1Schema: Schema<List1> = expandoObject({
  ...
  user: ['user', optional(lazy(() => user1Schema))],
  recurrings: ['recurrings', optional(array(lazy(() => recurringSchema)))],
  emailBlacklist: [
    'email_blacklist',
  ...
  children: ['children', optional(lazy(() => childrenSchema))],
});
