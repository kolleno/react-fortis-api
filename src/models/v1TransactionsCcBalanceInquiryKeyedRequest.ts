...
export interface V1TransactionsCcBalanceInquiryKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsCcBalanceInquiryKeyedRequestSchema: Schema<V1TransactionsCcBalanceInquiryKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
