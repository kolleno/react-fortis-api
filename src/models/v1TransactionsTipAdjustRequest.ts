...
export interface V1TransactionsTipAdjustRequest {
  /** Additional amounts */
...
export const v1TransactionsTipAdjustRequestSchema: Schema<V1TransactionsTipAdjustRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
