...
export interface V1TransactionsCcSaleWalletRequest {
  /** Additional amounts */
...
export const v1TransactionsCcSaleWalletRequestSchema: Schema<V1TransactionsCcSaleWalletRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
