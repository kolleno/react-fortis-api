...
export interface V1TransactionsAchDebitKeyedRequest {
  /** Additional amounts */
...
export const v1TransactionsAchDebitKeyedRequestSchema: Schema<V1TransactionsAchDebitKeyedRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
