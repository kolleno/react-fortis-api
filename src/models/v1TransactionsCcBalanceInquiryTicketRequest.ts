...
export interface V1TransactionsCcBalanceInquiryTicketRequest {
  /** Additional amounts */
...
export const v1TransactionsCcBalanceInquiryTicketRequestSchema: Schema<V1TransactionsCcBalanceInquiryTicketRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
