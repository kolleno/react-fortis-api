...
import {
  AccountVaultCauLog,
  accountVaultCauLogSchema,
} from './accountVaultCauLog';
import {
  AccountVaultCauProductTransaction,
  accountVaultCauProductTransactionSchema,
} from './accountVaultCauProductTransaction';
import { AchSecCode3Enum, achSecCode3EnumSchema } from './achSecCode3Enum';
import { ActiveRecurring, activeRecurringSchema } from './activeRecurring';
...
export interface List15 {
  ...
  activeRecurrings?: ActiveRecurring[];
  ...
  accountVaultCauLogs?: AccountVaultCauLog[];
  /** Token Cau Product Transaction Information on `expand` */
  accountVaultCauProductTransactions?: AccountVaultCauProductTransaction[];
  [key: string]: unknown;
}

export const list15Schema: Schema<List15> = expandoObject({
  ...
  activeRecurrings: [
    'activeRecurrings',
    optional(array(lazy(() => activeRecurringSchema))),
  ],
  ...
  accountVaultCauLogs: [
    ...
    optional(array(lazy(() => accountVaultCauLogSchema))),
  ],
  accountVaultCauProductTransactions: [
    'account_vault_cau_product_transactions',
    optional(array(lazy(() => accountVaultCauProductTransactionSchema))),
  ],
});
