...
export interface V1TransactionsAchRefundPrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsAchRefundPrevTrxnRequestSchema: Schema<V1TransactionsAchRefundPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
