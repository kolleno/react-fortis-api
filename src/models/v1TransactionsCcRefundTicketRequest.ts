...
export interface V1TransactionsCcRefundTicketRequest {
  /** Additional amounts */
...
export const v1TransactionsCcRefundTicketRequestSchema: Schema<V1TransactionsCcRefundTicketRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
