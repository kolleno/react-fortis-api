...
export interface V1TransactionsCcForcePrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsCcForcePrevTrxnRequestSchema: Schema<V1TransactionsCcForcePrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
