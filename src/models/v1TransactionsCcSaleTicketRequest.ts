...
export interface V1TransactionsCcSaleTicketRequest {
  /** Additional amounts */
...
export const v1TransactionsCcSaleTicketRequestSchema: Schema<V1TransactionsCcSaleTicketRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
