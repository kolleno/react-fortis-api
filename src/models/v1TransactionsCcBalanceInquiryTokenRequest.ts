...
export interface V1TransactionsCcBalanceInquiryTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsCcBalanceInquiryTokenRequestSchema: Schema<V1TransactionsCcBalanceInquiryTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
