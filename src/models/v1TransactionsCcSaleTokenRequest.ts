...
export interface V1TransactionsCcSaleTokenRequest {
  /** Additional amounts */
...
export const v1TransactionsCcSaleTokenRequestSchema: Schema<V1TransactionsCcSaleTokenRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
