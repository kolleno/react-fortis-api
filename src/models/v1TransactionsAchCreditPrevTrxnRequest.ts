...
export interface V1TransactionsAchCreditPrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsAchCreditPrevTrxnRequestSchema: Schema<V1TransactionsAchCreditPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
