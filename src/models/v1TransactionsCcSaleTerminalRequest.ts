...
export interface V1TransactionsCcSaleTerminalRequest {
  /** Additional amounts */
...
export const v1TransactionsCcSaleTerminalRequestSchema: Schema<V1TransactionsCcSaleTerminalRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
