...
import { EFormatEnum, eFormatEnumSchema } from './eFormatEnum';
import {
...
export interface V1TransactionsCcBalanceInquiryTerminalRequest {
  /** Additional amounts */
...
export const v1TransactionsCcBalanceInquiryTerminalRequestSchema: Schema<V1TransactionsCcBalanceInquiryTerminalRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
    ...
    eFormat: ['e_format', optional(nullable(eFormatEnumSchema))],
