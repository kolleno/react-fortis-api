...
export interface V1TransactionsCcRefundPrevTrxnRequest {
  /** Additional amounts */
...
export const v1TransactionsCcRefundPrevTrxnRequestSchema: Schema<V1TransactionsCcRefundPrevTrxnRequest> = expandoObject(
  {
    additionalAmounts: [
      'additional_amounts',
