...
import { Expand37Enum, expand37EnumSchema } from '../models/expand37Enum';
import { Field46Enum, field46EnumSchema } from '../models/field46Enum';
...
} from '../models/responseTerminal';
import {
  ResponseTerminalsCollection,
  responseTerminalsCollectionSchema,
} from '../models/responseTerminalsCollection';
import {
  V1TerminalsRequest,
  v1TerminalsRequestSchema,
} from '../models/v1TerminalsRequest';
import {
  V1TerminalsRequest1,
  v1TerminalsRequest1Schema,
} from '../models/v1TerminalsRequest1';
...
export class TerminalsController extends BaseController {
  ...
  async createANewTerminalDevice(
    ...
    const req = this.createRequest('POST', '/v1/terminals');
    const mapped = req.prepareArgs({
      body: [body, v1TerminalsRequestSchema],
      expand: [expand, optional(array(expand37EnumSchema))],
    });
    ...
    return req.callAsJson(responseTerminalSchema, requestOptions);
  }
  ...
  async listAllTerminalsRelated(
    ...
    const req = this.createRequest('GET', '/v1/terminals');
    const mapped = req.prepareArgs({
      ...
      fields: [fields, optional(array(field46EnumSchema))],
    });
    ...
    req.throwOn(401, Response401tokenError, 'Unauthorized');
    req.authenticate([{ userId: true, userApiKey: true, developerId: true }]);
    return req.callAsJson(responseTerminalsCollectionSchema, requestOptions);
  }
  ...
  async viewSingleTerminalsRecord(
    ...
    req.query('expand', mapped.expand);
    req.query('fields', mapped.fields);
    req.appendTemplatePath`/v1/terminals/${mapped.terminalId}`;
    req.throwOn(401, Response401tokenError, 'Unauthorized');
    req.authenticate([{ userId: true, userApiKey: true, developerId: true }]);
    return req.callAsJson(responseTerminalSchema, requestOptions);
  }
  ...
  async updateTerminalRecord(
    ...
    const mapped = req.prepareArgs({
      terminalId: [terminalId, string()],
      body: [body, v1TerminalsRequest1Schema],
      expand: [expand, optional(array(expand37EnumSchema))],
    });
    req.header('Content-Type', 'application/json');
    req.query('expand', mapped.expand);
