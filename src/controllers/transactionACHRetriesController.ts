...
import { Expand54Enum, expand54EnumSchema } from '../models/expand54Enum';
import { Field52Enum, field52EnumSchema } from '../models/field52Enum';
...
import {
  ...
  responseTransactionAchRetrySchema,
} from '../models/responseTransactionAchRetry';
import {
  ResponseTransactionAchRetrysCollection,
  responseTransactionAchRetrysCollectionSchema,
} from '../models/responseTransactionAchRetrysCollection';
import {
  V1TransactionAchRetriesRequest,
  v1TransactionAchRetriesRequestSchema,
} from '../models/v1TransactionAchRetriesRequest';
...
export class TransactionACHRetriesController extends BaseController {
  /**
   * @param body
  ...
  async createATransactionACHRetry(
    ...
    const req = this.createRequest('POST', '/v1/transaction-ach-retries');
    const mapped = req.prepareArgs({
      body: [body, v1TransactionAchRetriesRequestSchema],
      expand: [expand, optional(array(expand54EnumSchema))],
    });
    ...
    return req.callAsJson(responseTransactionAchRetrySchema, requestOptions);
  }
  ...
  async listAllTransactionACHRetriesRelated(
    ...
    const req = this.createRequest('GET', '/v1/transaction-ach-retries');
    const mapped = req.prepareArgs({
      ...
      fields: [fields, optional(array(field52EnumSchema))],
    });
  ...
  /**
   * @param transactionAchRetryId    Transaction ACH Retry ID.
  ...
  async viewSingleTransactionACHRetryRecord(
    ...
    const mapped = req.prepareArgs({
      transactionAchRetryId: [transactionAchRetryId, string()],
      expand: [expand, optional(array(expand54EnumSchema))],
      fields: [fields, optional(array(field52EnumSchema))],
    });
    req.query('expand', mapped.expand);
    req.query('fields', mapped.fields);
    req.appendTemplatePath`/v1/transaction-ach-retries/${mapped.transactionAchRetryId}`;
    req.throwOn(401, Response401tokenError, 'Unauthorized');
    req.authenticate([{ userId: true, userApiKey: true, developerId: true }]);
    return req.callAsJson(responseTransactionAchRetrySchema, requestOptions);
  }
