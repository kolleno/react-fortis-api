...
import {
  ResponseOnboarding,
  responseOnboardingSchema,
} from '../models/responseOnboarding';
import {
  V1OnboardingRequest,
  v1OnboardingRequestSchema,
} from '../models/v1OnboardingRequest';
...
export class OnBoardingController extends BaseController {
  ...
  async merchantBoarding(
    ...
    const req = this.createRequest('POST', '/v1/onboarding');
    const mapped = req.prepareArgs({ body: [body, v1OnboardingRequestSchema] });
    ...
    return req.callAsJson(responseOnboardingSchema, requestOptions);
  }
}
