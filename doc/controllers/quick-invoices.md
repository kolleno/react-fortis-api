...
```ts
const quickInvoicesController = new QuickInvoicesController(client);
```
...
```ts
const body: V1QuickInvoicesRequest = {
  title: 'My terminal',
  dueDate: '2021-12-01',
  itemList: [
    {
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.createANewQuickInvoice(body);
...
| `fields` | [`Field38Enum[] \| undefined`](../../doc/models/field-38-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.listAllQuickInvoicesRelated(
  page,
  order,
  filterBy
);
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.resend(quickInvoiceId);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
const body: V1QuickInvoicesTransactionRequest = {
  transactionId: '11e95f8ec39de8fbdb0a4f1a',
};

try {
  const { result, ...httpResponse } = await quickInvoicesController.associateTransactionWithOuickInvoice(
  quickInvoiceId,
  body
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.removeTransactionFromQuickInvoice(
  quickInvoiceId,
  body
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.deleteQuickInvoice(quickInvoiceId);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.viewSingleQuickInvoiceRecord(quickInvoiceId);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
const body: V1QuickInvoicesRequest1 = {
  locationId: '11e95f8ec39de8fbdb0a4f1a',
  title: 'My terminal',
  ccProductTransactionId: '11e95f8ec39de8fbdb0a4f1a',
  achProductTransactionId: '11e95f8ec39de8fbdb0a4f1a',
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.updateQuickInvoice(
  quickInvoiceId,
  body
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await quickInvoicesController.reopenQuickInvoice(quickInvoiceId);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
