...
```ts
const transactionsUpdatesController = new TransactionsUpdatesController(client);
```
...
try {
  const { result, ...httpResponse } = await transactionsUpdatesController.mVoid(transactionId);
...
const body: V1TransactionsVoidRequest = {
  description: 'some description',
};

try {
  const { result, ...httpResponse } = await transactionsUpdatesController.void1(
  transactionId,
  body
);
  // Get more response info...
...
const body: V1TransactionsAuthCompleteRequest = {
...
try {
  const { result, ...httpResponse } = await transactionsUpdatesController.authComplete(
  transactionId,
  body
);
  // Get more response info...
...
const body: V1TransactionsAuthIncrementRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsUpdatesController.authIncrement(
  transactionId,
  body
);
  // Get more response info...
...
const body: V1TransactionsPartialReversalRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsUpdatesController.partialReversal(
  transactionId,
  body
);
  // Get more response info...
...
const body: V1TransactionsRefundRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsUpdatesController.refundTransaction(
  transactionId,
  body
);
  // Get more response info...
...
const body: V1TransactionsTipAdjustRequest = {
  tipAmount: 0,
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
...
try {
  const { result, ...httpResponse } = await transactionsUpdatesController.tipAdjustment(
  transactionId,
  body
);
  // Get more response info...
