...
```ts
const transactionsEBTCardController = new TransactionsEBTCardController(client);
```
...
* [EBT Voucher Clear Refund](../../doc/controllers/transactions-ebt-card.md#ebt-voucher-clear-refund)
* [EBT Voucher Clear Sale](../../doc/controllers/transactions-ebt-card.md#ebt-voucher-clear-sale)


# EBT Voucher Clear Refund
...
```ts
const body: V1TransactionsEbtVoucherClearRefundKeyedRequest = {
...
try {
  const { result, ...httpResponse } = await transactionsEBTCardController.eBTVoucherClearRefund(body);
...
```ts
const body: V1TransactionsEbtVoucherClearSaleKeyedRequest = {
  accountNumber: '5454545454545454',
  expDate: '0722',
  authCode: 'abc12345',
  checkinDate: '2021-12-01',
...
try {
  const { result, ...httpResponse } = await transactionsEBTCardController.eBTVoucherClearSale(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
