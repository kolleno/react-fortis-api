...
```ts
const transactionsACHController = new TransactionsACHController(client);
```
...
```ts
const body: V1TransactionsAchCreditKeyedRequest = {
  transactionAmount: 1,
  ...
  customData: { 'data1': 'custom1', 'data2': 'custom2' },
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHCredit(body);
...
```ts
const body: V1TransactionsAchCreditPrevTrxnRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHCreditPreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsAchCreditTokenRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHCreditTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsAchDebitKeyedRequest = {
  transactionAmount: 1,
  accountHolderName: 'smith',
  accountNumber: '24345',
  accountType: AccountType16Enum.Checking,
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHDebit(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsAchDebitPrevTrxnRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHDebitPreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsAchDebitTokenRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHDebitTokenized(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
```ts
const body: V1TransactionsAchRefundPrevTrxnRequest = {
  transactionAmount: 1,
  checkinDate: '2021-12-01',
  checkoutDate: '2021-12-01',
  clerkNumber: 'AE1234',
...
try {
  const { result, ...httpResponse } = await transactionsACHController.aCHRefundPreviousTransaction(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
