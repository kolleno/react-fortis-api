...
| `relationship` | [`RelationshipEnum \| undefined`](../../doc/models/relationship-enum.md) | Query, Optional | Used to filter the type of locations that will be returned |
...
try {
  const { result, ...httpResponse } = await locationsController.locationsSearch(
  page,
  undefined,
  relationship
);
...
| `fields` | [`Field32Enum[] \| undefined`](../../doc/models/field-32-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await locationsController.locationsDetail(
  page,
  order,
  filterBy
);
