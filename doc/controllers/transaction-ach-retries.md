...
```ts
const transactionACHRetriesController = new TransactionACHRetriesController(client);
```
...
```ts
async createATransactionACHRetry(
  body: V1TransactionAchRetriesRequest,
  expand?: Expand54Enum[],
  requestOptions?: RequestOptions
): Promise<ApiResponse<ResponseTransactionAchRetry>>
```
...
```ts
const body: V1TransactionAchRetriesRequest = {
  rejectedTransactionId: '11e95f8ec39de8fbdb0a4f1a',
};

try {
  const { result, ...httpResponse } = await transactionACHRetriesController.createATransactionACHRetry(body);
...
```ts
async listAllTransactionACHRetriesRelated(
  page?: Page,
  order?: Order20[],
  filterBy?: FilterBy[],
  expand?: Expand54Enum[],
  ...
  fields?: Field52Enum[],
  requestOptions?: RequestOptions
): Promise<ApiResponse<ResponseTransactionAchRetrysCollection>>
```
...
| `fields` | [`Field52Enum[] \| undefined`](../../doc/models/field-52-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await transactionACHRetriesController.listAllTransactionACHRetriesRelated(
  page,
  order,
  filterBy
);
...
```ts
async viewSingleTransactionACHRetryRecord(
  transactionAchRetryId: string,
  expand?: Expand54Enum[],
  fields?: Field52Enum[],
  requestOptions?: RequestOptions
): Promise<ApiResponse<ResponseTransactionAchRetry>>
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `transactionAchRetryId` | `string` | Template, Required | Transaction ACH Retry ID.<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
| `expand` | [`Expand54Enum[] \| undefined`](../../doc/models/expand-54-enum.md) | Query, Optional | Most endpoints in the API have a way to retrieve extra data related to the current record being retrieved. For example, if the API request is for the accountvaults endpoint, and the end user also needs to know which contact the token belongs to, this data can be returned in the accountvaults endpoint request.<br>**Constraints**: *Unique Items Required*, *Pattern*: `^[\w]+$` |
| `fields` | [`Field52Enum[] \| undefined`](../../doc/models/field-52-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await transactionACHRetriesController.viewSingleTransactionACHRetryRecord(transactionAchRetryId);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
