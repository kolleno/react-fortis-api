...
```ts
const deviceTermsController = new DeviceTermsController(client);
```
...
```ts
const body: V1DeviceTermsRequest = {
...
try {
  const { result, ...httpResponse } = await deviceTermsController.createANewDeviceTerm(body);
...
| `fields` | [`Field30Enum[] \| undefined`](../../doc/models/field-30-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await deviceTermsController.listAllDeviceTermsRelated(
  page,
  order,
  filterBy
);
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `deviceTermsId` | `string` | Template, Required | Device term ID<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
| `expand` | [`Expand8Enum[] \| undefined`](../../doc/models/expand-8-enum.md) | Query, Optional | Most endpoints in the API have a way to retrieve extra data related to the current record being retrieved. For example, if the API request is for the accountvaults endpoint, and the end user also needs to know which contact the token belongs to, this data can be returned in the accountvaults endpoint request.<br>**Constraints**: *Unique Items Required*, *Pattern*: `^[\w]+$` |
| `fields` | [`Field30Enum[] \| undefined`](../../doc/models/field-30-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await deviceTermsController.viewSingleDeviceTermRecord(deviceTermsId);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
