...
# V1 Transactions Cc Balance Inquiry Terminal Request
...
| `terminalApiId` | `string \| null \| undefined` | Optional | Advance Deposit<br>**Constraints**: *Maximum Length*: `36` |
| `eFormat` | [`EFormatEnum \| null \| undefined`](../../doc/models/e-format-enum.md) | Optional | Encrypted Track Data Format. |
| `eTrackData` | `string \| null \| undefined` | Optional | Encrypted Track Data |
| `eSerialNumber` | `string \| null \| undefined` | Optional | Encrypted Track Data KSN<br>**Constraints**: *Maximum Length*: `20` |
