...
|  --- | --- | --- | --- |
| `nextRunDate` | `string \| null \| undefined` | Optional | Next Run Date<br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
...
| `tokenId` | `string \| null \| undefined` | Optional | Token ID<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
...
| `interval` | `number \| null \| undefined` | Optional | Interval<br>**Constraints**: `>= 0`, `<= 365` |
| `intervalType` | [`IntervalTypeEnum \| null \| undefined`](../../doc/models/interval-type-enum.md) | Optional | Interval Type |
...
| `startDate` | `string \| null \| undefined` | Optional | Start date<br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` |
