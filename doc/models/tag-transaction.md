...
| `tagId` | `string \| undefined` | Optional | Tag |
...
| `paymentMethod` | `string \| null \| undefined` | Optional | Payment Method |
| `created` | `string \| null \| undefined` | Optional | Created |
| `modified` | `string \| null \| undefined` | Optional | Modified |
