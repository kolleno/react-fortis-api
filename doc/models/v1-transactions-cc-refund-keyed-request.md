...
| `accountNumber` | [`V1TransactionsCcRefundKeyedRequestAccountNumber \| undefined`](../../doc/models/containers/v1-transactions-cc-refund-keyed-request-account-number.md) | Optional | This is a container for any-of cases. |
...
| `expDate` | [`V1TransactionsCcRefundKeyedRequestExpDate \| undefined`](../../doc/models/containers/v1-transactions-cc-refund-keyed-request-exp-date.md) | Optional | This is a container for any-of cases. |
| `trackData` | `string \| null \| undefined` | Optional | Track Data from a magnetic card swipe.<br>**Constraints**: *Maximum Length*: `256` |
| `pin` | `string \| null \| undefined` | Optional | Pin |
| `ksn` | `string \| null \| undefined` | Optional | KSN (Key Serial Number) |
