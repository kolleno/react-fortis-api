...
# V1 Transactions Cc Auth Only Taptopay Request
...
```json
{
  ...
  "bill_payment": true,
  "delay_charge": true,
  "card_data_cryptogram": "card_data_cryptogram6",
  "general_card_data": "general_card_data8",
  "card_reader_id": "card_reader_id8",
  "additional_amounts": [
    {
      "type": "cashback",
      "amount": 6,
